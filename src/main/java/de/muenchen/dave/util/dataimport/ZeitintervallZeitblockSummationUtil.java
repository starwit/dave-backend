...
public final class ZeitintervallZeitblockSummationUtil {
    ...
    public static List<Zeitintervall> getSummen(final List<Zeitintervall> zeitintervalle) {
        ...
        possibleVerkehrsbeziehungen
                .forEach(verkehrsbeziehung -> blockSummen.addAll(getSummenForVerkehrsbeziehung(verkehrsbeziehung, zeitintervalleGroupedByIntervall)));
        return blockSummen;
    }
     ...
     *
     * @param verkehrsbeziehung Die für die Summierung relevante {@link Verkehrsbeziehung}.
    ...
    private static List<Zeitintervall> getSummenForVerkehrsbeziehung(
        ...
        final Optional<UUID> zaehlungId = zeitintervalleForVerkehrsbeziehung.stream()
                ...
                .findFirst();
        final StartEndeUhrzeit startEndeUhrzeit = getStartAndEndeuhrzeit(zeitintervalleForVerkehrsbeziehung);
        ...
        if (zaehlungId.isPresent()) {
            Stream.of(Zeitblock.values())
                    ...
                    .forEach(zeitblock -> getSumme(zaehlungId.get(), zeitblock, verkehrsbeziehung, zeitintervalleForVerkehrsbeziehung)
            ...
            if (summen.size() < 1) {
                Optional<Zeitintervall> zeitintervallSummeOptional = getSummeZeitraum(zaehlungId.get(), startEndeUhrzeit.startUhrzeit,
                        startEndeUhrzeit.endeUhrzeit, verkehrsbeziehung, zeitintervalleForVerkehrsbeziehung);
